...
class Curricula4toPrimaria {
  ...
  static const List<TemaPrimaria> temas = [
    ...
    TemaPrimaria(
      ...
      explicacion:
          'Inferir es leer entre líneas. El texto no lo dice todo, '
    ...
    TemaPrimaria(
      ...
      titulo: 'El afiche',
      explicacion:
          'Un afiche es un aviso grande que llama la atención. '
    ...
    TemaPrimaria(
      ...
      titulo: 'El cuento',
      explicacion:
          'Un cuento tiene tres partes: inicio, nudo y desenlace. '
    ...
    TemaPrimaria(
      ...
      titulo: 'La noticia',
      explicacion:
          'Una noticia cuenta algo real que pasó. '
    ...
    TemaPrimaria(
      ...
      explicacion:
          'Los sinónimos son palabras con significado parecido: '
    ...
    TemaPrimaria(
      ...
      explicacion:
          'Un texto instructivo te dice cómo hacer algo paso a paso. '
    ...
    TemaPrimaria(
      ...
      explicacion:
          'El adjetivo calificativo describe al sustantivo. '
    ...
    TemaPrimaria(
      ...
      explicacion:
          'Un patrón numérico es una secuencia que sigue una regla. '
    ...
    TemaPrimaria(
      ...
      explicacion:
          'Medimos con unidades: el metro para longitudes, '
    ...
    TemaPrimaria(
      ...
      explicacion:
          'En el Perú usamos soles y céntimos. '
    ...
    TemaPrimaria(
      ...
      explicacion:
          'El sistema digestivo transforma la comida en nutrientes. '
  ...
  static const Map<String, String> respuestasDefault = {
    ...
    'com_04':
        'Todo cuento tiene inicio, nudo y desenlace. '
        '¿Te cuento un cuento corto y lo armamos por partes?',
    'com_05':
        'La noticia responde qué, quién, cuándo y dónde. '
        '¿Querés armar una noticia con esas cuatro preguntas?',
    'com_06':
        'Sinónimos se parecen en significado; antónimos se oponen. '
        '¿Practicamos con algunas palabras?',
    'com_07':
        'El texto instructivo te guía paso a paso, como una receta. '
        '¿Querés un ejemplo de instrucciones simples?',
    'com_08':
        'El adjetivo calificativo describe cómo es algo o alguien. '
    ...
    'mat_03':
        'En un patrón hay una regla que se repite. '
        '¿Seguimos juntos una secuencia de números?',
    'mat_04':
        'Dividir es repartir en partes iguales. '
        '¿Querés un problema de galletas o de lápices?',
    'mat_05':
        'Usamos metro, litro y kilogramo según lo que midamos. '
        '¿Te doy ejemplos de la vida diaria?',
    'mat_06':
        'En un gráfico de barras, la altura muestra la cantidad. '
        '¿Leemos un gráfico juntos?',
    'mat_07':
        'Perímetro es el contorno; área es lo de adentro. '
        '¿Calculamos el de un rectángulo simple?',
    'mat_08':
        'Con soles y céntimos podés sumar precios y sacar el vuelto. '
        '¿Hacemos un problema de compra?',
    'cyt_01':
        'Costa, sierra y selva son ecosistemas distintos del Perú. '
    ...
    'cyt_05':
        'Las plantas hacen fotosíntesis y nos dan oxígeno. '
        '¿Repasamos raíz, tallo y hojas?',
    'cyt_06':
        'El agua cambia de estado y recorre el ciclo del agua. '
        '¿Vemos evaporación, nubes y lluvia?',
    'cyt_07':
        'Huesos y músculos trabajan juntos para que te muevas. '
        '¿Querés un ejemplo de un movimiento simple?',
    'cyt_08':
        'Los cinco sentidos nos ayudan a conocer el mundo. '
